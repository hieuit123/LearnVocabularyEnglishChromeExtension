...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 19, 2021 lúc 08:47 AM
...
INSERT INTO `account` (`AC_Id`, `AC_userName`, `AC_fullName`, `AC_Email`, `AC_Streak`, `AC_Exp`, `AC_State`, `AC_Role`, `AC_idExpOfOneDay`) VALUES
(1, 'phongle0509', 'Trần Thanh Phong', 'tranthanhphong050999@gmail.com', 0, 0, 0, 0, 0);
...
INSERT INTO `wordbook` (`WB_Id`, `WB_Name`) VALUES
(1, 'ok'),
(2, 'no');
